...
As described in lecture, the Lotka-Volterra models have been used to describe predator-prey populations. One tiny change!
...
parameters <- c(r = .75, alpha = 0.75, beta = 0.55, q = 1)
